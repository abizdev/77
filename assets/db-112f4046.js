...
`,d=e=>`
    ...
    <div class="container">
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-3 md:gap-4">
          ...
          ${e===null?`<button class="login-btn btn btn-secondary icon-login before:text-black flex-row-reverse">
        <span class="hidden md:block">Войти</span>
      </button>`:`<a href="#!" class="btn btn-secondary flex items-center gap-2">
        <img src="${e.profile_photo?e.profile_photo:"/images/no-user.jpg"}" class="rounded-full w-[30px] h-[30px]" alt="user" />
  ...
  `,g=e=>`
  <!-- categories-item -->
  <article class="categories__item h-[85px] relative item-border rounded-xl pr-3 pl-11 py-[22px] flex items-center justify-end gap-6 shadow-md col-span-1 w-11/12 xl:w-[336px] w-full cursor-pointer" data-id="${e.id}">
    ...
    <div class="categories__item--img absolute top-[50%] -left-9 -translate-y-[50%] w-16 h-16 item-border rounded-xl flex items-center justify-center shadow-md transition duration-300">
      <img src="${e.icon}" alt="category">
    </div>

    <div class="categories__item--info flex flex-col flex-grow gap-1">
      <h4 class="text-base/[119%] font-semibold">${e.name}</h4>
      <p class="text-sm text-gray-300">${e.product_count} обьявлений</p>
    </div>

    <button class="icon-chevron-right transition duration-300 before:text-slate-300"></button>

  </article>
  `,u=(e,s)=>{if(!s||!s.length){e.classList.replace("dropdown-grid","dropdown-flex"),e.innerHTML+=`
    ...
    `;return}s.forEach(a=>{e.classList.replace("dropdown-flex","dropdown-grid"),e.innerHTML+=`
    <a href="${a.linkUrl}" class="dropdown__item icon-chevron-right p-3 flex flex-row-reverse items-center gap-[10px]">
      <h5 class="flex-grow text-sm text-black font-medium">${a.name}</h5>
    </a>
    `})},f=e=>`
  <!-- product card -->
  ...
  `,c=document.querySelector("body");let o=null;const p=()=>{localStorage.user&&(o=JSON.parse(localStorage.user)),c.insertAdjacentHTML("afterbegin",d(o))};p();c.insertAdjacentHTML("beforeend",n);const b=[{title:"Холодильники",saved:!1,linkUrl:"/src/pages/products.html"},{title:"Телевизоры",saved:!1,linkUrl:"/src/pages/products.html"},{title:"Наушники и аксессуары",saved:!1,linkUrl:"/src/pages/products.html"},{title:"Кухонная мебель",saved:!1,linkUrl:"/src/pages/products.html"},{title:"Телефоны",saved:!1,linkUrl:"/src/pages/products.html"},{title:"Бытовая техника",saved:!1,linkUrl:"/src/pages/products.html"},{title:"Микроволновки",saved:!1,linkUrl:"/src/pages/products.html"}],x=[{id:Math.random(),imgUrl:"/images/products/card1.jpg",images:[{imgUrl:"/images/single-product/slide1.jpg",imgAlt:"slider-img"},{imgUrl:"/images/single-product/slide2.jpg",imgAlt:"slider-img"},{imgUrl:"/images/single-product/slide3.jpg",imgAlt:"slider-img"},{imgUrl:"/images/single-product/slide4.jpg",imgAlt:"slider-img"},{imgUrl:"/images/single-product/slide5.jpg",imgAlt:"slider-img"},{imgUrl:"/images/single-product/slide6.jpg",imgAlt:"slider-img"},{imgUrl:"/images/single-product/slide7.jpg",imgAlt:"slider-img"}],isLiked:!1,city:"г. Ташкент",name:"Кепки Corneliani Diamond for him edition.",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:2599e3},{id:Math.random(),imgUrl:"/images/products/card2.jpg",isLiked:!1,city:"г. Самарканд",name:"Chevrolet Onix 1.2 Turbo в наличии",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:204e6},{id:Math.random(),imgUrl:"/images/products/card3.jpg",isLiked:!1,city:"г. Ташкент",name:"7Saber Trucker Cap",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:28e4},{id:Math.random(),imgUrl:"/images/products/card4.jpg",isLiked:!1,city:"г. Ташкент",name:"Оригинальные кроссовки Nike Air Max Plus",productUrl:"../../pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:482e4},{id:Math.random(),imgUrl:"/images/products/card5.jpg",isLiked:!1,city:"г. Ташкент",name:"Оригинальные кроссовки Nike Air Max 97",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:482e4},{id:Math.random(),imgUrl:"/images/products/card6.jpg",isLiked:!1,city:"г. Ташкент",name:"Apple Watch Series 8 - USA Non active",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:45e5},{id:Math.random(),imgUrl:"/images/products/card7.jpg",isLiked:!1,city:"г. Самарканд",name:"Лучший кроссовер Geely Monjaro Limited Edition",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:32e7},{id:Math.random(),imgUrl:"/images/products/card8.jpg",isLiked:!1,city:"г. Ташкент",name:"Стайлер для волос Dyson airwrap complete long",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:500},{id:Math.random(),imgUrl:"/images/products/card1.jpg",isLiked:!1,city:"г. Ташкент",name:"Кепки Corneliani Diamond for him edition.",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:2599e3},{id:Math.random(),imgUrl:"/images/products/card2.jpg",isLiked:!1,city:"г. Самарканд",name:"Chevrolet Onix 1.2 Turbo в наличии",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:204e6},{id:Math.random(),imgUrl:"/images/products/card3.jpg",isLiked:!1,city:"г. Ташкент",name:"7Saber Trucker Cap",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:28e4},{id:Math.random(),imgUrl:"/images/products/card4.jpg",isLiked:!1,city:"г. Ташкент",name:"Оригинальные кроссовки Nike Air Max Plus",productUrl:"/src/pages/product.html",date:"Вчера, 19:20",phone:"+998712007007",price:482e4}];export{m as a,u as b,h as c,f as d,g,x as p,b as s};
